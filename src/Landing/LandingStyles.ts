...
export const SignUpToggle = styled.button`
    font-weight: 600;
    margin: 1rem 0.3rem 0.8rem 0.3rem;
    width: 100%;
    color: #e0e5eb;
    background-color: #202730;
    border: none;
